...
function updateCanvas(){
    ...
    ctx.drawImage(playerSpriteRight, playerXPosition-30, playerYPosition-PLAYER_IMAGE_HEIGHT+10, PLAYER_IMAGE_WIDTH, PLAYER_IMAGE_HEIGHT)
        ...
        flipHorizontally(playerSpriteRight,playerXPosition-30, playerYPosition-PLAYER_IMAGE_HEIGHT+10, PLAYER_IMAGE_WIDTH, PLAYER_IMAGE_HEIGHT)
    } 

    playerXPosition = playerXPosition + playerXSpeed
    playerYPosition = playerYPosition - playerYSpeed
    
    console.log(obstacleArray[0].xPosition)
    ...
    count = 0
    while(count < obstacleArray.length){
        if(isTouching(playerXPosition, playerYPosition, PLAYER_IMAGE_WIDTH, PLAYER_IMAGE_HEIGHT, 
